...
public class QuotesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        ordersAdapter = new OrdersAdapter(getContext(), upcomingOrdersList, R.layout.all_received_orders_layout);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (Map.Entry<String, Object> entry : orders.entrySet()) {
                        ...
                        if(Objects.requireNonNull(seller.get("uid")).toString().equals(currentUserID)) {
