...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,R.id.nav_catalog, R.id.nav_profile,R.id.nav_settings)
        ...
        profileUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    String myProfileImage = "profile image";
                    String myProfileName ="profile name";
                    String myEmail = "email";
                    if (dataSnapshot.hasChild("profileimage")) {
                        myProfileImage  = Objects.requireNonNull(dataSnapshot.child("profileimage").getValue()).toString();
                    }
